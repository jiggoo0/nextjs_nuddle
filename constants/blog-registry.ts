...
export const blogRegistry: BlogEntry[] = [
  {
    ...
    date: "2026-03-13",
    excerpt:
      "เจาะลึกเบื้องหลังการปรับตัวของร้าน ช.สหชัย สู่ระบบจัดการข้อมูลและ SEO ที่มีประสิทธิภาพ พัฒนาโดย AEMDEVWEB",
    category: "Technology",
  ...
  },
  {
    ...
    date: "2026-03-13",
    excerpt:
      "รวมรายการเมนูทั้งหมดของร้าน ช.สหชัย ทั้งสายเส้นและสายข้าว พร้อมราคาที่เป็นธรรมและปริมาณที่จุใจ",
    category: "Menu",
  ...
  },
  {
    ...
    date: "2026-03-12",
    excerpt:
      "ความภูมิใจในการได้รับความไว้วางใจให้จัดเลี้ยงนอกสถานที่ ณ กองบังคับการตำรวจตระเวนชายแดน จังหวัดตาก",
  ...
  },
  {
    ...
    date: "2026-03-11",
    excerpt:
      "บันทึกผลงานการจัดเลี้ยงนอกสถานที่เพื่อเติมพลังให้แก่เจ้าหน้าที่สำนักงานสรรพากรจังหวัดตาก ในงานประชุมประจำปี",
    category: "Performance",
  ...
  },
  {
    ...
    date: "2026-03-10",
    excerpt:
      "เปิดสูตรลับความอร่อยที่มัดใจชาวตากมาเกือบสิบปี ตั้งแต่เส้นบะหมี่นวดมือไปจนถึงเนื้อปูแกะสดใหม่",
    category: "Story",
  ...
  },
  {
    ...
    date: "2026-03-05",
    excerpt:
      "ทำไมหมูแดงที่นี่ถึงหอมและนุ่มไม่เหมือนใคร? ตามไปดูเทคนิคการย่างด้วยเตาถ่านโบราณของเฮียเนกที่รักษามาตรฐานมานานกว่า 9 ปี",
    category: "Kitchen",
    image: "menu1.jpg",
  },
  {
    ...
    date: "2026-03-01",
    excerpt:
      "เจาะลึกวิธีการสั่งเมนูเด็ดและสูตรผสมความอร่อยที่ทำให้บะหมี่ไข่ 98% ของเรามัดใจลูกค้ามาอย่างยาวนาน",
    category: "Guide",
  ...
  },
  {
    ...
    date: "2026-02-28",
    excerpt:
      "รวมแผนเที่ยวจังหวัดตากแบบวันเดียวครบ จัดเต็มจุดเช็คอินสำคัญและร้านอร่อยที่ไม่ควรพลาดสำหรับนักเดินทาง",
    category: "Travel",
    image: "menu8.jpg",
  },
];
