...
export const siteIdentity = {
  ...
  description: "แวะมาฝากท้องกับร้านลับเมืองตาก ช.สหชัย เกี๊ยวปูหมูแดง สัมผัสบะหมี่ทำเองไข่ 98% เหนียวหนึบสู้ฟัน หมูแดงย่างเตาถ่านหอมๆ บรรยากาศอบอุ่น ราคาเป็นกันเอง ครองใจคนตากมากว่า 9 ปี",
  url: "https://sahachai.aemdevweb.com",
  ogImage: "/images/founders-warmth.webp",
  themeColor: "#b22222",
  keywords: ["ร้านอาหารตาก 2568", "ของกินเมืองตาก", "ร้านอร่อยจังหวัดตาก", "บะหมี่ทำเอง ตาก", "บะหมี่ตาก", "ร้านลับเมืองตาก", "ช.สหชัย เกี๊ยวปูหมูแดง", "จัดเลี้ยงนอกสถานที่ ตาก"]
};
...
export const heroContent = {
  ...
  description: "เฮียเนกและเจ๊ตั๊กตั้งใจทำบะหมี่ไข่สด 98% นวดเองทุกวัน เพื่อให้ทุกคนได้ทานของอร่อย เครื่องแน่นจุใจ ในราคาที่สบายกระเป๋า แวะมาทานกันให้อิ่มท้องนะครับ",
...
export const signatureFeatures = [
  ...
  export const cateringService = {
    ...
    description: "บริการจัดเลี้ยงบะหมี่เกี๊ยวปู-หมูแดง สำหรับงานบุญ งานบวช งานแต่ง หรือหน่วยงานราชการในจังหวัดตาก เริ่มต้นเพียง 150 ชามขึ้นไป พร้อมอุปกรณ์ครบวงจร",
    highlights: ["เส้นบะหมี่ทำใหม่สด", "หมูแดงย่างเตาถ่านหอมๆ", "บริการรวดเร็วโดยทีมงานมืออาชีพ"],
    cta: "สอบถามราคาเหมา",
  };
  export const pricingContent = {  badge: "เมนูยอดฮิต",
