...
export const signatureFeatures = [
  ...
  description: "บริการจัดเลี้ยงบะหมี่เกี๊ยวปู-หมูแดง สำหรับงานบุญ งานบวช งานแต่ง หรือหน่วยงานราชการในจังหวัดตาก เริ่มต้นเพียง 50 ชามขึ้นไป พร้อมอุปกรณ์ครบวงจร",
